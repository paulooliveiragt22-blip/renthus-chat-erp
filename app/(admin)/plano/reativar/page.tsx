    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      <header className="border-b border-zinc-200 bg-white px-4 py-4 dark:border-zinc-800 dark:bg-zinc-900">
        <div className="mx-auto flex max-w-lg items-center justify-between">
          <img src="/brand/renthus-wordmark-on-light.svg" alt="RenthusAgent" className="h-7 w-auto dark:hidden" />
          <img src="/brand/renthus-wordmark-on-dark.svg" alt="RenthusAgent" className="hidden h-7 w-auto dark:block" />
