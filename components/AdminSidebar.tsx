...
export default function AdminSidebar() {
    ...
    // nova state para o OrdersStatsModal (última correção)
    ...
    return (
        <>
            ...
            >
                ...
                {!collapsed ? (
                    <>
                        ...
                        {/* area de botões (adicionada para abrir o modal de estatísticas e manter cadastro) */}
                        <div style={{ marginTop: 14, display: "flex", flexDirection: "column", gap: 8 }}>
                            ...
                            <Link href="/produtos" style={{ textDecoration: "none" }}>
                                <div style={{ padding: "8px 10px", borderRadius: 8, background: "transparent", color: "#fff", border: `1px solid ${SIDEBAR_BORDER}`, cursor: "pointer" }}>
                                    Cadastrar produto
                                </div>
                            </Link>
                        </div>
            ...
            {/* Modais - renderizados fora do aside */}
            {openThread ? (
