-- C3: ao fulfill subscription, decrementa promo_months_remaining (R3-1).
...
comment on function public.rpc_fulfill_obligation(text, text, text, text) is
  'Claim invoice; seat_add bump seats; subscription renew decrementa promo_months_remaining.';
