-- Boost leve no RPC para descritores comuns / CX / volume mencionados na query.
-- O rerank fino continua em lib/chatbot/pro/searchRelevance.ts (app).
...
COMMENT ON FUNCTION public.rpc_search_chat_produtos(uuid, text, integer) IS
  'Busca fuzzy chatbot + boost long neck/CX; rerank fino no app (searchRelevance.ts).';
