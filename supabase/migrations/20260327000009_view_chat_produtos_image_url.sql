-- Adiciona thumbnail_url à view_chat_produtos via JOIN com product_images (is_primary)
...
COMMENT ON VIEW public.view_chat_produtos IS
  'Produtos+embalagens para chatbot. Cada linha = 1 embalagem. Agrupar por (produto_id, product_volume_id) para obter variantes de volume distintas. Inclui thumbnail_url/image_url da imagem principal.';
