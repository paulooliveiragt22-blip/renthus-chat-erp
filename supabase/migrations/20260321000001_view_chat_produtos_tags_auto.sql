-- ============================================================
-- view_chat_produtos: adiciona tags_auto
-- tags_auto é gerado automaticamente a partir dos campos do produto,
-- eliminando dependência de preenchimento manual do campo tags.
-- ============================================================
...
COMMENT ON VIEW public.view_chat_produtos IS
  'Produtos+embalagens para chatbot. Inclui tags_auto gerado automaticamente para busca fuzzy.';
