-- view_chat_produtos: imagem preferencial por variante de volume (piv),
-- fallback para imagem do produto (pip) quando não há imagem específica do volume
...
-- imagem específica do volume (prioridade)
