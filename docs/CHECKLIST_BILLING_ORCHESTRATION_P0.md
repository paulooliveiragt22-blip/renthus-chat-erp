...
| O1.5 | Alerta mínimo | Sentry message ou cron watchdog | Se houve create-checkout e **0** eventos webhook em 24h → alerta (pode ser `[~]` após O1.3 verde) | [x] 2026-09-02 — `GET /api/billing/webhook-health` + cron 6h |
